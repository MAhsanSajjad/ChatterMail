...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('email_app_management', '0012_paymenthistory'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.CharField(choices=[('teacher', 'Teacher'), ('admin', 'Admin'), ('staff', 'Staff')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='email_app_management.employee')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
